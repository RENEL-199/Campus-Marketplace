...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .detail-head { display: flex; align-items: start; justify-content: space-between; gap: 14px; margin-bottom: 16px; }
...
<nav>
    ...
    <div>
        ...
        <a href="lost_found.php"><i class="fa-solid fa-box-open"></i></a>
