...
<div class="container">
    ...
    <div class="categories">
        ...
        <div class="category">Preloved</div>
    </div>
    ...
    <div class="grid">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <h3>2nd Hand Calculator</h3>
                <p>Good condition, slightly used.</p>
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <p>Noise cancelling, long battery life.</p>
